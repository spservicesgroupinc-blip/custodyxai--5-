    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="mt-2 text-base text-gray-600">This is your command center. Review key metrics and take action.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard 
                    ...
                    description="All documented events" 
                />
                <StatCard 
                ...
                <StatCard 
                    ...
                    description="Total communication-related reports"
                />
                <StatCard 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <ActionCard 
                    ...
                    description="Start a conversation with the AI to document a new event."
                    icon={<PlusIcon className="w-7 h-7 text-blue-800"/>}
                    onClick={() => onViewChange('new_report')}
                 />
                 <ActionCard 
                    title="View Calendar & Timeline"
                    description="See all your logged incidents in a monthly calendar or chronological view."
