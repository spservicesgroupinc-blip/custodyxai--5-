...
const LegalAssistant: React.FC<LegalAssistantProps> = ({ reports, documents, userProfile, activeReportContext, clearActiveReportContext, initialQuery, clearInitialQuery, activeAnalysisContext, clearActiveAnalysisContext, onAddDocument, isOffline }) => {
    ...
    }, [activeReportContext, reports, documents, userProfile, clearActiveReportContext, initialQuery, clearInitialQuery, activeAnalysisContext, onAddDocument, clearActiveAnalysisContext, isLoading, isOffline]);
                                        ...
                                        {analyzedDocInfo?.analysisMessageId === index && (
                                            <div className="mt-3 pt-3 border-t border-gray-200">
                                                <button
                                                    ...
                                                    title={isOffline ? "Redrafting is disabled while offline." : ""}
                                                >
                    ...
                    <div className="p-4 bg-white border-t border-gray-200 rounded-b-lg">
                        <div className="relative">
                            <input
                                ...
                                placeholder={isOffline ? "You are offline. AI assistant is unavailable." : "Ask a question or request a document..."}
