...
const EvidencePackageBuilder: React.FC<EvidencePackageBuilderProps> = ({ isOpen, onClose, selectedReports, allDocuments, userProfile, onPackageCreated, onAddDocument, isOffline }) => {
                        ...
                        <>
                            ...
                            {step === 2 && (
                                <button
                                    ...
                                    title={isOffline ? "Package generation is disabled while offline." : ""}
                                >
