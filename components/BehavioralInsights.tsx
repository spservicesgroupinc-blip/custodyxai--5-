...
const DeepAnalysis: React.FC<DeepAnalysisProps> = ({ reports, userProfile, activeInsightContext, onBackToTimeline, onGenerateDraft, onAddDocument, isOffline }) => {
    ...
    useEffect(() => {
        ...
        fetchInsights();
    }, [activeInsightContext, reports, userProfile, onAddDocument, isOffline]);
